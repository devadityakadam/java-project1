...
public class client implements ActionListener{
    ...
    client(){
        ...
        JLabel stetus=new JLabel("online");
        stetus.setBounds( 110,35,100,18);
        stetus.setForeground(Color.WHITE);
        stetus.setFont(new Font("SAN_SERIF",Font.BOLD,14));
        p1.add(stetus);
        
        a1=new JPanel();
        a1.setBounds(5, 75, 440, 600);
        f.add(a1);
        
         text = new JTextField();
        text.setBounds(5,675,310,40);
